...
def main() -> None:
    ...
    preliminary_portfolio = calculate_premium(
        policy_df,
        portfolio_frequency,
        portfolio_severity,
        pricing_config=DEFAULT_PRICING_CONFIG,
    ...
    risk_thresholds = compute_risk_thresholds(preliminary_portfolio["pure_premium"])
    ...
    metadata = _build_metadata(policy_df, severity_df, data_quality, risk_thresholds)
